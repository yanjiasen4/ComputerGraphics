...
void InitGL()
{
	...
	orb[0] = new Orb(0.0, 0.0, 0.0, orb_r, 0.003, 0.002, 0.0);
	orb[1] = new Orb(1.0, 0.0, 0.0, orb_r, 0.005, 0.004, 0.0);
	orb[2] = new Orb(0.0, 1.0, 0.0, orb_r, 0.004, -0.006, 0.0);
	orb[3] = new Orb(1.0, 1.0, 0.0, orb_r, 0.008, 0.001, 0.0);
	orb[4] = new Orb(1.0, -1.0, 0.0, orb_r, 0.003, 0.006, 0.0);
	orb[5] = new Orb(-1.0, 0.0, 0.0, orb_r, 0.002, 0.002, 0.0);
	ghost[0] = new Orb(5.0, 4.0, 0.0, orb_r, 0, 0, 0);
	ghost[1] = new Orb(0.0, 4.0, 0.0, orb_r, 0, 0, 0);
	ghost[2] = new Orb(-5.0, 4.0, 0.0, orb_r, 0, 0, 0);
	ghost[3] = new Orb(5.0, -4.0, 0.0, orb_r, 0, 0, 0);
	ghost[4] = new Orb(0.0, -4.0, 0.0, orb_r, 0, 0, 0);
	ghost[5] = new Orb(-5.0, -4.0, 0.0, orb_r, 0, 0, 0);
